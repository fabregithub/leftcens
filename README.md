...
x
#> <cens_data> 7 observations (log_transform = TRUE)
#>   non_detect               3
#>   detected_not_quantified  2
#>   quantified               2
#> 
#>  left right                category
#>   0.0   0.5              non_detect
#>   0.0   0.5              non_detect
#>   0.5   2.0 detected_not_quantified
#>   3.1   3.1              quantified
#>   4.2   4.2              quantified
#>   0.0   0.5              non_detect
#>   ... and 1 more
...
- `vignette("getting-started", package = "leftcens")` — the data model
  and the descriptive-statistics tools.
